...
- [目录](#目录)
	- [MemCraft 能做什么](#memcraft-能做什么)
		- [面向普通用户](#面向普通用户)
		- [面向研究者](#面向研究者)
	- [项目结构](#项目结构)
	- [已实现的 Memory Baseline](#已实现的-memory-baseline)
	- [快速开始](#快速开始)
		- [1. Clone](#1-clone)
	...
	- [MemCraft 工作流](#memcraft-工作流)
	- [前端 Dashboard](#前端-dashboard)
	- [如何 DIY 一个新的 Memory](#如何-diy-一个新的-memory)
		- [函数接口](#函数接口)
		- [最小可运行模板](#最小可运行模板)
		- [配置加载](#配置加载)
		- [实现建议](#实现建议)
...
- MEMORY_STORE_CLASS=YourMemory（仅当同模块有多个 memory 类时需要指定）
