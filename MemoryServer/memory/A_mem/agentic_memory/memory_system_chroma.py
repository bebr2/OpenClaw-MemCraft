...
def tyc_str_to_json(response: str):
    for x in re.findall(r'\{.*?\}', response, re.DOTALL):
...
class AgenticMemorySystem:
    ...
    def __init__(self, 
                 ...
                 chroma_db_path: Optional[str] = os.path.join(os.getcwd(), "chroma_db")):  
        ...
        self.retriever = ChromaRetriever(
            ...
            if_exists=os.path.exists(chroma_db_path)
        )
    ...
    def consolidate_memories(self):
        ...
        self.retriever = ChromaRetriever(collection_name="memories",model_name=self.model_name, chroma_db_path=self.chroma_db_path)
